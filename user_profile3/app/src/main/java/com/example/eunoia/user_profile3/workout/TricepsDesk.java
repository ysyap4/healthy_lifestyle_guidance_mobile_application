...
public class TricepsDesk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_triceps_desk);

        Start=(ImageButton)findViewById(R.id.button14);
        Stop=(ImageButton)findViewById(R.id.button15);
    ...
    public void adTri(View i){
        Intent intent = new Intent(this, bookPress.class);
        startActivity(intent);
    }
