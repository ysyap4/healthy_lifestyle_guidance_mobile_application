...
public class chairSquat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chair_squat);

        Start=(ImageButton)findViewById(R.id.button7);
        Stop=(ImageButton)findViewById(R.id.button8);
    ...
    public void plusChair(View c){
        Intent intent = new Intent(this, TricepsDesk.class);
        startActivity(intent);
    }
